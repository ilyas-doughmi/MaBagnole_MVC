    ...
    <div class="flex-grow flex items-center justify-center pt-20 px-4">
        <div class="max-w-lg w-full bg-white rounded-3xl shadow-2xl overflow-hidden text-center relative">
            ...
            <div class="p-10 md:p-12">
                ...
                <div class="space-y-3">
                    <a href="/" class="block w-full bg-black hover:bg-locar-orange text-white font-bold py-4 rounded-xl shadow-lg transition transform hover:-translate-y-1">
                        RETOUR À L'ACCUEIL
                    </a>
                    <a href="/vehicle" class="block w-full bg-white border-2 border-gray-100 hover:border-black text-gray-900 font-bold py-4 rounded-xl transition">
