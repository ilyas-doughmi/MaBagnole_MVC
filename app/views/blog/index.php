            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="lg:w-3/4">
                    ...
                    <div class="group relative rounded-2xl overflow-hidden shadow-2xl mb-12 h-[400px] md:h-[500px]">
                        <img src="<?= $data['posts'][0]['media'] ?>" class="absolute inset-0 w-full h-full object-cover transform group-hover:scale-105 transition duration-700">
                        ...
                        <div class="absolute bottom-0 left-0 p-8 md:p-12">
                            ...
                            <div class="flex items-center text-gray-300 text-sm font-bold gap-4">
                                ...
                                <span><i class="fa-solid fa-calendar mr-2 text-locar-orange"></i> <?= $data['posts'][0]['createdAt'] ?></span>
                            </div>
                        </div>
                        <a href="/blog/show/<?= $data['posts'][0]['artid'] ?>" class="absolute inset-0 z-20"></a>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <article class="bg-white rounded-2xl overflow-hidden shadow-card border border-gray-100 hover:shadow-neon hover:border-locar-orange/30 transition duration-300 group flex flex-col h-full">
                            ...
                            <div class="p-8 flex-1 flex flex-col">
                                ...
                                <div class="mt-auto">
                                    <a href="/blog/show/<?= $post["artid"] ?>" class="inline-flex items-center text-sm font-black text-locar-black hover:text-locar-orange transition uppercase tracking-wide">
                ...
                <aside class="lg:w-1/4 space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <a href="/article/add" class="flex items-center justify-center w-full bg-locar-black text-white font-bold py-3 rounded hover:bg-locar-orange transition uppercase text-xs tracking-wider">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="/blog/index?category=<?= $cat["id"] ?>" class="flex justify-between items-center text-gray-500 font-bold text-sm hover:text-locar-orange hover:bg-orange-50 p-2 rounded transition group">
                                    <span><?= $cat["name"] ?></span>
                                    <span class="bg-gray-100 text-gray-400 text-xs px-2 py-1 rounded group-hover:bg-locar-orange group-hover:text-white transition"><?= isset($cat['count']) ? $cat['count'] : 0 ?></span>
                                </a>
                            </li>
                            <?php endforeach; ?>
                            <?php endif; ?>
