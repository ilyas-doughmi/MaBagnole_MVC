    ...
    <main class="flex-grow py-20 px-6 bg-gray-50 relative">
        ...
        <div class="container mx-auto max-w-7xl relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <a href="/blog/index?category=<?= $theme['id'] ?>" class="group relative h-[400px] rounded-3xl overflow-hidden card-hover-effect bg-white border border-gray-100">
                    ...
                    <div class="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r <?= isset($theme['color']) ? $theme['color'] : 'from-brand-orange to-red-500' ?> transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                </a>
                <?php endforeach; ?>
                <?php endif; ?>
            ...
            <div class="text-center mt-16">
                <a href="/blog" class="inline-flex items-center gap-3 text-brand-black hover:text-brand-orange font-bold uppercase tracking-widest text-xs transition-colors group">
