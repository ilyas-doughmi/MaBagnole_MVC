    ...
    <div class="max-w-7xl mx-auto px-4 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex items-center gap-4">
                ...
                <?php else: ?>
                    <a href="login" class="flex items-center gap-2 font-bold text-xs bg-[#0a0a0a] text-white px-6 py-3 rounded-full hover:bg-[#FF3B00] transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 duration-300">
